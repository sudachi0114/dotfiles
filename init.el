...
(custom-set-variables
 ...
 '(package-selected-packages
   '(use-package lsp-ui lsp-mode company-go 0blayout rust-mode markdown-mode atom-one-dark-theme solarized-theme auto-complete package-utils go-mode nyan-mode monokai-theme init-loader hiwin)))
(custom-set-faces
