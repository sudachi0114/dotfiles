...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company-go 0blayout rust-mode markdown-mode atom-one-dark-theme solarized-theme auto-complete package-utils go-mode nyan-mode monokai-theme init-loader hiwin)))
(custom-set-faces
